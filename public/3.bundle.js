...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      axios.get('http://www.omdbapi.com/?i=' + this.assignShow(this.props.params.id).imdbID).then(function (response) {
	        _this2.props.updateShowRating(_this2.props.params.id, response.data.imdbRating);
	    ...
	    value: function render() {
	      ...
	      var rating = _assignShow.rating;


	      var ratingElement = void 0;

	      if (rating) {
	        ratingElement = React.createElement(
	          'h3',
	...
	Details.propTypes = {
	  ...
	  params: object,
	  updateShowRating: func.isRequired
	};
